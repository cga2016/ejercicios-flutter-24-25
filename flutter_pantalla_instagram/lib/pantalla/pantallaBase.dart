...
import 'package:flutter_pantalla_instagram/tools/Tab2.dart';
import 'package:flutter_pantalla_instagram/tools/galeriaDEImagenes.dart';

import '../tools/CreadorDeCabecera.dart';

/*Clase que se encarga de la construcción de la pantalla */
class BaseDeLaPantalla extends StatefulWidget {
  const BaseDeLaPantalla({super.key});

  @override

  // ignore: library_private_types_in_public_api
  _BaseDeLaPantallaState createState() => _BaseDeLaPantallaState();
}

class _BaseDeLaPantallaState extends State<BaseDeLaPantalla> {
  @override
